...
import { CLIENT_ORDERS_QUERY_RESULT } from "@/sanity.types";
							...
							<TooltipTrigger asChild>
								...
								>
									...
									<TableCell>
										{order?.status && (
											<span
												className={`px-2 py-1 rounded-full text-xs capitalize font-semibold ${order?.status === "paid" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}
											>
												{order?.status}
											</span>
										)}
